...
export default class PetServicesSearchScreen extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            servicesListDataSource: ds.cloneWithRows(servicesList),
            loading: true
        }
    }
    ...
    componentDidMount(){
        ...
        if(this.props.data.filterCount === 0){
            FirebaseRequest.fetchServicesAndGroups()
                .then((servicesArray) => {
            ...
            FirebaseRequest.searchForGroupsAndServices(this.props.data)
                .then((servicesArray) => {
                ...
                .catch((err) => { console.error("Error fecthing services, ", err.message) })
        }
        ...
        return(
            <View style={styles.container}>
                {!this.state.loading ?
                    (
                        <ListView
                            dataSource={this.state.servicesListDataSource}
