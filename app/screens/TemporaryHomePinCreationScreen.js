...
export default class StreetAnimalPinCreationScreen extends Component{
    ...
    createPin(){
        ...
        navigator.geolocation.getCurrentPosition((position) => {
            ...
            .catch((err) => {alert('Erro ao criar pin.')})
                    ...
                    >
                        ...
                        <Menu 
                         ...
                         >
                            ...
                            >
                                    <Image 
                                    source={require("../Resources/pinCompleteTemporaryHome.png")}
                                        style={styles.icon}
                                        resizeMode='contain'
                                    />
                            </TouchableOpacity>
