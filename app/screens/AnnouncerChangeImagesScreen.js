...
export default class AnnouncerChangeImagesScreen extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            loading: false,
            logoImage: FirebaseRequest.getCurrentService().logoImage,
            backgroundImage: FirebaseRequest.getCurrentService().backgroundImage,
            switchState: FirebaseRequest.getCurrentService().sale,
        ...
        if(value === true){
            ...
            Alert.alert('Atenção', 'Deseja mesmo cancelar a promoção?',
                [
                    ...
                    {
                        text: 'Ok', onPress: () => {
                            FirebaseRequest.updateServiceSaleStatus(false)
                                .then(() => {
                                    this.setState({
                                        switchState: false,
                                    })
                                ...
                                .catch((err) => {
                                    alert("Erro ao tentar atualizar o status de promoção. ")
                                })
                        }
                    }
    ...
    acceptPayment(){
        ...
        FirebaseRequest.updateServiceSaleStatus(true)
            .then(() => {
                ...
                >
                    ...
                    <View style={styles.choosePlanButtonContainer}>
                            <TouchableOpacity
                                    ...
                                    onPress={() => this.updateServiceImages()}
                                >
