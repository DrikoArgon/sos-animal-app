...
export default class AnimalEditScreen extends Component {
    ...
    updatePet() {
        ...
        FirebaseRequest.updateGroupAnimalProfile({
            name: this.name,
                ...
                },
                {
                    text: 'Ok', onPress: () => {
                        ...
                        if (this.oldPetSituation === 0) {
                            ...
                            FirebaseRequest.removeGroupAnimal(this.props.data.key)
                                .then(() => {
                                    this.setState({
                                        removing: false
                                    })
                            ...
                            FirebaseRequest.removeGroupAdoptedAnimal(this.props.data.key)
                                .then(() => {
                                    this.setState({
                                        removing: false
                                    })
