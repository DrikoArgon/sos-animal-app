...
export default class AnnouncerLoginScreen extends Component{
    ...
    submitForm(){
        ...
        .then((authData) => {
            FirebaseRequest.loadUserService(authData.uid)
                ...
                .catch((err) => { 
                    Alert.alert('', 'Erro ao carregar informações de usuário.',
                        [
                            {
                                text: 'Ok', onPress: () => { }
                            }
        ...
        return(
            <View style={styles.container}>
                 ...
                 <View style={styles.footer}>
                        ...
                        <TouchableOpacity 
                            activeOpacity={0.5}
                            onPress={() => {this.props.toRoute(Routes.serviceRegistration())}}
                        >
