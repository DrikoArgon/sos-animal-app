...
export default class AddNewAnimalScreen extends Component {
    ...
    constructor(props){
        ...
        this.state = {
            ...
            colorDropdownSelection: 'Selecione',
            vaccinatedDropdownSelection: 'Selecione',
            dewormedDropdownSelection: 'Selecione',
            castratedDropdownSelection: 'Selecione',
            photoSource: null,
            profilePhoto: null,
            loading: false
        }
    ...
    addAnimal() {
        ...
        FirebaseRequest.addGroupAnimal({
            name: this.name,
            ...
            .catch((err) => { console.error("Failed to add animal, ", err.message) })
                ...
                <View style={styles.container}>
                    <ScrollView
                                ...
                                {this.state.photoSource ? (
                                    ...
                                    />
                                        ...
                                        <View style={styles.noPhotoBackground}>
                                            <Text style={styles.noPhotoBackgroundText}>Toque para selecionar foto</Text>
                                        </View>
                                    )}
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={styles.rowContainer}>
                            ...
                            <SegmentedControlTab
                                values={['Para adoção','Adotado']}
                                selectedIndex={0}
                                tabTextStyle={styles.tabTextStyle}
                                tabsContainerStyle={styles.tabContainerStyle}
                                tabStyle={styles.tabStyle}
                                activeTabStyle={styles.activeTabStyle}
                                onTabPress={index => this.petSituation = index}
                            />
                            <TouchableOpacity 
                            ...
                            >
                                ...
                                <Text style={styles.addButtonText}>{this.state.loading ? 'Adicionando...' : 'Adicionar'}</Text>
                                </View>
                            </TouchableOpacity>
                        </ScrollView>
                    </View>
