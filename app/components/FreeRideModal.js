...
export default class FreeRideModal extends Component{

    constructor(props){
        super(props)

        this.to = this.props.data.destination
    ...
    updatePin() {
        ...
        FirebaseRequest.updatePin({
            ...
            destination: this.state.destinationChanged ? this.destination : this.props.data.destination,
                                ...
                                <View style={styles.innerModalContainer}>
                                    <View style={styles.modalHeader}>
                                        ...
                                        <View style={styles.modalHeaderTextContainer}>
                                            <Text style={styles.modalHeaderText}>TRANSPORTE SOLIDÁRIO</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.modalTextContainerDark}>
                                        ...
                                        <TextInput 
                                            ref={(ref) => this._toRef = ref}
                                            placeholder={this.props.data.to}
                                            placeholderTextColor="white"
                                            selectionColor="white"
                                            style={styles.bigInput}
                                            autoCapitalize="none"
                                            autoCorrect={false}
                                            onChangeText={(to) => {this.to = to
                                                                    this.setState({
