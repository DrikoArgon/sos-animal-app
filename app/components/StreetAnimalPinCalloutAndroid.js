...
export default class StreetAnimalPinCalloutAndroid extends Component {
        ...
        .then((commentsArray) => {
            ...
            for(var i = 0; i < commentsArray.length; i++){
                ...
                FirebaseRequest.fetchPinCommentOwnerInfo(commentsArray[i],i)
                    ...
                    .catch((err) => { console.error("Erro ao encontrar as informações do autor do comentário. ", err.message) })
            }
    ...
    searchUserInfo() {
        ...
        console.log("Pesquisando informações do dono do pin. Pin Owner ID: ", this.props.data.pinOwnerID)
        FirebaseRequest.fetchPersonInfo(this.props.data.pinOwnerID)
            ...
            .catch((err) => { alert("Erro ao encontrar informações do dono deste pin. Verifique sua conexão de internet.")
                            ...
                            <View style={styles.innerModalContainer}>
                                <View style={styles.header}>
                                    ...
                                    <View style={styles.headerTextContainer}>
                                        <Text style={styles.headerText}>ANIMAL NA RUA</Text>
                                    </View>
                                    <View>
                                    </View>
                                </View>
                                ...
                                >
                                    ...
                                    <View style={styles.innerContainer}>
                                        <Text style={styles.infoText}>Idade Aproximada</Text>
                                        <View style={styles.infoContainer}>
                                    ...
                                    <View style={styles.innerContainer}>
                                        ...
                                        <View style={styles.infoContainer}>
                                            <Text style={styles.infoText}>{this.props.data.qtd}</Text>
                                        </View>
                                    </View>
                                    <View style={styles.innerContainer}>
...
*/}
                ...
                <PinCommentModal
                    ...
                    hideModals={() => this.hideModals()}
                    headerColor={StyleVars.Colors.animalStreetPinBackground}
