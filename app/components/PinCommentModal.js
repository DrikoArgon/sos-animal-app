...
export default class PinCommentModal extends Component{
    ...
    addComment(){
        ...
        FirebaseRequest.addNewCommentToPin(this.props.pinID,this.text)
        .then(() => {
            this.setState({
                sendingComment: false
            })
        ...
        .catch((err) => {
            Alert.alert('', 'Erro ao adicionar novo comentário ao pin.',
                [
                    {
                        text: 'Ok', onPress: () => { }
                    }
    ...
    addCommentToService(){
        ...
        FirebaseRequest.addNewCommentToServiceOrGroup(this.props.pinID,this.text,false)
        .then(() => {
            this.setState({
                sendingComment: false
            })
        ...
        .catch((err) => {
            console.error("Error while trying to add new comment to pin: ", err.message)
            this.setState({
                sendingComment: false
            })
        })
                            ...
                            <View style={styles.innerModalContainer}>
                                ...
                                <View style={styles.buttomContainer}>
                                    <TouchableOpacity
                                        ...
                                        onPress={() =>this.props.isServicePin ? this.addCommentToService() : this.addComment()}
                                    >
