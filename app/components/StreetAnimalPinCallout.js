...
export default class StreetAnimalPinCallout extends React.Component {
  ...
  sharePinInfo(){
    ...
    var sharePhotoContent = this.defineShareContent()
  ...
  defineShareContent(){
      ...
      if(this.props.data.images.length === 1){
            shareContent = {
                ...
                photos: [
                    {
                        imageUrl: 'data:image/png;base64,' + this.props.data.images[0],
                        userGenerated: false,
                        caption: 'Testani'
                    }
                ] 
            ...
            shareContent = {
                ...
                photos: [
                    ...
                    {
                        imageUrl: 'data:image/png;base64,' + this.props.data.images[1],
                        userGenerated: false,
                        caption: 'Testani'
                    }
                ] 
            ...
            shareContent = {
                ...
                photos: [
                    ...
                    {
                        imageUrl: 'data:image/png;base64,' + this.props.data.images[2],
                        userGenerated: false,
                        caption: 'Testani'
                    }
                ] 
            ...
            shareContent = {
                ...
                photos: [
                    ...
                    {
                        imageUrl: 'data:image/png;base64,' + this.props.data.images[3],
                        userGenerated: false,
                        caption: 'Testani'
                    }
                ] 
...
const styles = StyleSheet.create({
  ...
  arrow: {
    ...
    borderTopColor: StyleVars.Colors.animalStreetPinBackground,
    alignSelf: 'center',
    marginTop: 0
  },
  arrowBorder: {
