...
export default class RunawayAnimalPinCallout extends React.Component {
            ...
            >   
                ...
                <View style={styles.innerContainer}>
                    ...
                    <View style={styles.infoContainer}>
                        <Text style={styles.infoText}>{this.data.runawayDate}</Text>
                    </View>
                </View>
                <View style={styles.innerContainer}>
                    <Text style={styles.infoText}>Nome</Text>
                    <View style={styles.infoContainer}>
                        <Text style={styles.infoText}>{this.data.name}</Text>
                    </View>
                </View>
                <View style={styles.innerContainer}>
                ...
                <View style={styles.innerContainer}>
                    ...
                    <View style={styles.infoContainer}>
                        <Text style={styles.infoText}>{this.data.breed}</Text>
                    </View>
                </View>
                <View style={styles.innerContainer}>
                    <Text style={styles.infoText}>Sexo</Text>
                    <View style={styles.infoContainer}>
                        <Text style={styles.infoText}>{this.data.gender}</Text>
                    </View>
                </View>
                <View style={styles.innerContainer}>
...
const styles = StyleSheet.create({
  ...
  arrow: {
    ...
    borderTopColor: StyleVars.Colors.runawayAnimalPinBackground,
    alignSelf: 'center',
    marginTop: 0
  },
  arrowBorder: {
