...
export default class TemporaryHomePinCalloutAndroid extends Component {
    ...
    searchUserInfo() {
        ...
        FirebaseRequest.fetchPersonInfo(this.props.data.pinOwnerID)
            ...
            .catch((err) => {
                alert("Erro ao encontrar informações do dono deste pin. Verifique sua conexão de internet.")
                            ...
                            <View style={styles.innerModalContainer}>
                                <View style={styles.header}>
                                    ...
                                    <View style={styles.headerTextContainer}>
                                        <Text style={styles.headerText}>LAR TEMPORÁRIO (PRECISO)</Text>
                                    </View>
                                    <View>
                                    </View>
                                </View>
...
*/}
                ...
                <PinCommentModal
                    ...
                    hideModals={() => this.hideModals()}
                    headerColor={StyleVars.Colors.temporaryHomePinBackground}
...
const styles = StyleSheet.create({
    ...
    header: {
        backgroundColor: StyleVars.Colors.temporaryHomePinBackground,
        flexDirection: 'row',
