...
export default class MilkFullPinCallout extends React.Component {
        ...
        <View style={styles.bubble}>
            <View style={styles.header}>
                ...
                <View style={styles.headerTextContainer}>
                    <Text style={styles.headerText}>MÃE DE LEITE (TENHO)</Text>
                </View>
                <View>
                </View>
            </View>
            ...
            >
                ...
                <View style={styles.innerContainer}>
                    <Text style={styles.infoText}>Idade da Mãe</Text>
                    <View style={styles.infoContainer}>
...
*/}
         ...
         <PinCommentModal
            ...
            hideModals={() => this.hideModals()}
            headerColor={StyleVars.Colors.milkFullPinBackground}
            pinID={this.data.key}
        />
         <EditPinCommentModal
...
const styles = StyleSheet.create({
  ...
  arrow: {
    ...
    borderTopColor: StyleVars.Colors.milkFullPinBackground,
    alignSelf: 'center',
    marginTop: 0
  },
  arrowBorder: {
