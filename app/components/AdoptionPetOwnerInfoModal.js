...
export default class AdoptionPetOwnerInfoModal extends Component {
                            ...
                            <View style={styles.innerModalContainer}>
                                <View style={styles.modalHeader}>
                                    <View style={styles.modalHeaderTextContainer}>
                                        <Text style={styles.modalHeaderText}>QUERO ADOTAR</Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.modalTextContainerLight}>
                                    <Text style={styles.modalText}>Comunique-se com este dono!</Text>
                                </View>
                                <View style={styles.modalTextContainerLightSide}>
                                    <Text style={styles.modalText}>Email: {this.props.data.email}</Text>
                                </View>
                                <View style={styles.modalTextContainerLightSide}>
                                    <Text style={styles.modalText}>Telefone: {this.props.data.phone}</Text>
                                </View>
                                <View style={styles.modalTextContainerLightSide}>
                                    <Text style={styles.modalText}>Celular: {this.props.data.celphone}</Text>
                                </View>
