...
export default class MilkEmptyPinCalloutAndroid extends Component {
    ...
    searchUserInfo() {
        ...
        FirebaseRequest.fetchPersonInfo(this.props.data.pinOwnerID)
            ...
            .catch((err) => {
                Alert.alert('', 'Erro ao encontrar informações do dono deste pin. Verifique sua conexão de internet.',
                    [
                        {
                            text: 'Ok', onPress: () => { }
                        }
                            ...
                            <View style={styles.innerModalContainer}>
                                <View style={styles.header}>
                                    ...
                                    <View style={styles.headerTextContainer}>
                                        <Text style={styles.headerText}>MÃE DE LEITE (PRECISO)</Text>
                                    </View>
                                    <View>
                                    </View>
                                </View>
                                ...
                                >
                                    ...
                                    <View style={styles.innerContainer}>
                                        <Text style={styles.infoText}>Idade dos Filhotes</Text>
                                        <View style={styles.infoContainer}>
                                            <Text style={styles.infoText}>{this.props.data.ageAmount} {this.props.data.ageType}</Text>
                                        </View>
                                    </View>
                                    <View style={styles.innerContainer}>
                                        <Text style={styles.infoText}>Quantidade de Filhotes</Text>
                                        <View style={styles.infoContainer}>
...
*/}
                ...
                <PinCommentModal
                    ...
                    hideModals={() => this.hideModals()}
                    headerColor={StyleVars.Colors.milkEmptyPinBackground}
