...
export default class MilkEmptyModal extends Component{
                                ...
                                <View style={styles.innerModalContainer}>
                                    <View style={styles.modalHeader}>
                                        ...
                                        <View style={styles.modalHeaderTextContainer}>
                                            <Text style={styles.modalHeaderText}>MÃE DE LEITE (PRECISO)</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.modalTextContainerDark}>
                                        <Text style={styles.modalText}>Idade dos filhotes:</Text>
                                        <TextInput 
                                    ...
                                    <View style={styles.modalTextContainerLight}>
                                        <Text style={styles.modalText}>Quantidade de filhotes:</Text>
                                        <TextInput 
